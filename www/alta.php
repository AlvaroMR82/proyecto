      ...
      <div class="row  mb-5 mt-5 ">
        <form class="row g-3">
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" name="apellido" id="inputEmail4" >
          </div>
          <div class="col-md-6">
          ...
          <div class="col-md-6">
            ...
            <input type="email" class="form-control" id="inputEmail4" name="email" placeholder="ejemplo@correo.com">
          </div>
          <div class="col-md-6">
